...
namespace _06._03._23_HW
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                new Order(random.Next(1000, 9999), "Никита", new List<Product>() { new Product("Ноутбук",39999.0)}),
                new Order(random.Next(1000, 9999), "Дима", new List<Product>() { new Product("Провод",250.0) }),
                new Order(random.Next(1000, 9999), "Даня", new List<Product>() { new Product("Наушники",1099.00)}),
                new Order(random.Next(1000, 9999), "Сережа", new List<Product>() { new Product("SSD", 3000.00)})
            };
